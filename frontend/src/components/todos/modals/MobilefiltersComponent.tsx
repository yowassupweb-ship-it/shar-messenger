...
interface MobilefiltersComponentProps {
  people: Person[];
  isOpen: boolean;
  onClose: () => void;
}}

const MobilefiltersComponent = memo(function MobilefiltersComponent({people, isOpen, onClose}: MobilefiltersComponentProps) {
  return (
