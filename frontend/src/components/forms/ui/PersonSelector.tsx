        ...
        <div className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-[var(--bg-secondary)] border border-gray-200 dark:border-[var(--border-color)] rounded-xl shadow-lg max-h-60 overflow-y-auto z-50">
          {people.map((person) => (
            <button
              ...
              className="w-full px-3 py-2 text-left hover:bg-gray-100 dark:hover:bg-white/5 transition-colors text-sm text-gray-900 dark:text-[var(--text-primary)] flex items-center justify-between"
            >
