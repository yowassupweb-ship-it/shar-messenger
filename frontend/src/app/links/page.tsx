...
export default function LinksPage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#0a0a0a] text-white">
      {/* Header */}
      <header className="h-12 bg-[#1a1a1a] border-b border-white/5 flex items-center px-4 flex-shrink-0">
        <Link href="/" className="flex items-center gap-2 mr-6 text-white/60 hover:text-white transition-colors">
          <ArrowLeft className="w-4 h-4" />
          <span className="text-sm">Назад</span>
        </Link>
        <div className="flex items-center gap-2">
          <Globe className="w-5 h-5 text-blue-400" />
          <span className="font-semibold">База ссылок</span>
        </div>
        ...
        >
          ...
          <span className="hidden sm:inline">Добавить ссылку</span>
        </button>
      </header>
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Sidebar */}
        <aside className="w-64 flex-shrink-0 border-r border-white/5 flex flex-col bg-[#0d0d0d] overflow-hidden">
                      ...
                      <div className="flex-1 min-w-0 overflow-hidden">
                        <div className="flex items-center gap-2 flex-wrap">
                          <a 
                            ...
                            className="font-medium text-sm text-white hover:text-blue-400 transition-colors break-all"
                          >
                            {link.title}
                          </a>
      ...
      {/* Status Bar */}
      <footer className="h-6 bg-[#1a1a1a] border-t border-white/5 flex items-center px-4 text-[10px] flex-shrink-0">
        <div className="flex items-center gap-4 text-white/30">
          <span className="flex items-center gap-1">
            <span className="w-1.5 h-1.5 rounded-full bg-green-500"></span>
            Готово
          </span>
          <span>Ссылок: {links.length}</span>
          <span>Списков: {lists.length}</span>
