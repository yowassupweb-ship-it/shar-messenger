      ...
      <div className="flex items-center gap-1 w-full max-w-[650px] mx-auto px-[5px] py-0">
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            className="w-full pl-12 md:pl-11 pr-12 md:pr-11 py-3 md:py-3 min-h-[44px] md:min-h-[40px] text-[15px] md:text-[13px] text-gray-900 dark:text-gray-100 bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 rounded-[24px] md:rounded-[22px] focus:outline-none focus:border-gray-300 dark:focus:border-gray-600 resize-none overflow-y-auto scrollbar-hide leading-5 md:leading-5 block placeholder:select-none"
            style={{
              maxHeight: '200px',
            }}
            rows={1}
