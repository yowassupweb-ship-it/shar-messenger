  ...
  return (
    <div>
      ...
      <div className="flex items-start justify-between mb-8 gap-6">
        ...
        <button className="flex-shrink-0 bg-[var(--button)] text-white px-6 py-2 rounded-lg hover:bg-[var(--button)]/90 transition-colors whitespace-nowrap flex items-center gap-2">
      ...
      {displayType === 'cards' && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredFeeds.map((feed) => (
            <div key={feed.id} className="card hover:border-[var(--button)] transition-colors group flex flex-col min-h-[280px] w-full">
              ...
              <div className="mt-auto pt-4 border-t border-[var(--border)] flex gap-2">
                <Link href={`/feed-editor/feeds/${feed.id}`} className="flex-1 bg-[var(--button)] text-white py-2 rounded-lg hover:bg-[var(--button)]/90 transition-colors text-center">
                  Открыть
                </Link>
                  ...
                  <tr key={feed.id} className="border-b border-[var(--border)] hover:bg-[var(--background)] transition-colors">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex gap-2">
                        <Link href={`/feed-editor/feeds/${feed.id}`} className="text-[var(--button)] hover:text-[var(--button)]/80 transition-colors">
                          Открыть
                        </Link>
            ...
            {filteredFeeds.map((feed) => (
              <div key={feed.id} className="flex items-center justify-between p-4 border border-[var(--border)] rounded-lg hover:border-[var(--button)] transition-colors group">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Link href={`/feed-editor/feeds/${feed.id}`} className="bg-[var(--button)] text-white px-4 py-2 rounded-lg hover:bg-[var(--button)]/90 transition-colors">
                    Открыть
                  </Link>
                </div>
              </div>
